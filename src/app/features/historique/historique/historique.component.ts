          ...
          <table class="table table-hover table-sm align-middle mb-0">
            ...
            <tbody>
              @for (t of ticketsPagines(); track t.id_ticket) {
                ...
                <tr>
                  <td colspan="7" class="text-center text-muted py-3">Aucun ticket trouvé</td>
                </tr>
              }
            </tbody>
          ...
          <table class="table table-hover table-sm align-middle mb-0">
            ...
            <tbody>
              ...
              @for (r of statsArticlesPagines(); track r.code) {
                ...
                <tr>
                  <td colspan="7" class="text-center text-muted py-3">Aucune vente sur cette période</td>
                </tr>
              }
            </tbody>
...
export class HistoriqueComponent implements OnInit {
  ...
  ticketsFiltres = computed(() => {
    const { search, select } = this.filterState();
